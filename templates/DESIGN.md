...
- **Change ID**: <id>
- **关联**: `@.specs/<id>/REQUIREMENT.md`、`@.specs/CONTEXT.md`、`@flow-wtg/reference/tech-stacks.md`
...
> 后续用户跑 `@flow-wtg/prompts/A-evolve.md` 会扫这段，逐项 review，批准的内容 patch 到 `.specs/CONTEXT.md`。
