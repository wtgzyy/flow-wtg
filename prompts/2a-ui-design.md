...
- `@.specs/CONTEXT.md`
- `@flow-wtg/reference/ui-aesthetics.md`（决策框架）
- `@flow-wtg/reference/ui-anti-patterns.md`（反 AI-slop 清单）
...
- `.specs/<id>/UI-DESIGN.md`（必填）
  - 使用 `@flow-wtg/templates/UI-DESIGN.md` 模板
...
`@flow-wtg/prompts/3-task.md` —— 拆任务时把 design tokens 物化到代码（CSS variables / theme 文件）作为第一批任务
