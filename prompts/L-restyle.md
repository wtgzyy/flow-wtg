...
> 用法：`@flow-wtg/prompts/L-restyle.md` + 一句话目标
...
- `@flow-wtg/reference/ui-aesthetics.md`（调性卡片）
- `@flow-wtg/reference/ui-anti-patterns.md`
...
- 用户确认 → `@flow-wtg/prompts/3-task.md`（按上述波次落实任务）
- → `@flow-wtg/prompts/4-dev.md`（每任务 fresh context，UI 任务自动扫 anti-patterns）
- → `@flow-wtg/prompts/6-review.md`（**第三轮 UI 视觉审查必跑**，含 v1 vs v2 对比段）
- → `@flow-wtg/prompts/7-integration.md`（UAT 重点：老用户能否完成关键流程；视觉是否传达声明的调性）
